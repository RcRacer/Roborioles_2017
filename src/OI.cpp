...
OI::OI() {
    ...
    SmartDashboard::PutData("WaitCmd", new WaitCmd(0));
    ...
    SmartDashboard::PutData("AutoTurn", new AutoTurn(.3,120	));
    SmartDashboard::PutData("AutoForward", new AutoForward(0,392));
