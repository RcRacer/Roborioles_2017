...
DriveBase::DriveBase() : Subsystem("DriveBase") {
    ...
    shootsensor = RobotMap::driveBaseShootsensor;

    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DECLARATIONS
    ShootSensor = RobotMap::driveBaseShootSensor;
    ShooterLight = RobotMap::driveBaseShooterLight;
...
double DriveBase::SonarInches() {
	return sonar->GetRangeInches()-11.5; //was 8.5
}

double DriveBase::ShootInches() {
	return ShootSensor->GetRangeInches();
}
...
void DriveBase::ShootLightOn(bool light){
	ShooterLight->Set(light);
}
