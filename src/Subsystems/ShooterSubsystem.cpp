...
void ShooterSubsystem::PrintValues(){
	std::string cannon1= "Cannon Spd1: "+std::to_string(talonController->GetSpeed());
	std::string cannon2= "Cannon Spd2: "+std::to_string(talonController2->GetSpeed());
	...
	frc::SmartDashboard::PutString("DB/String 5", cannon1);
	frc::SmartDashboard::PutString("DB/String 6", cannon2);
}
