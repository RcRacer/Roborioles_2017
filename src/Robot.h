...
#include "Subsystems/GearPneumatics.h"
#include "Subsystems/IntakeMot.h"
...
public:
    ...
    static std::shared_ptr<GearPneumatics> gearPneumatics;
    static std::shared_ptr<IntakeMot> intakeMot;
